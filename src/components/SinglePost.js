...
function SinglePost() {
    ...
    useEffect(() => {
        ...
        }`).then(data => setSinglePost(data[0])).catch(err=> console.log(err))
    }, [slug])
    ...
    return (
        <main className="bg-gray-200 min-h-screen p-12">
            <article className="container shadow-lg mx-auto bg-green-100 rounded-lg">
                ...
                <div className="px-16 lg:px-48 py-12 lg:py-20 prose lg:prose-xl max-w-full"><BlockContent blocks={singlePost.body} projectId="9l18h0bx" dataset="production"/></div>
            </article>
        </main>
    )
}
